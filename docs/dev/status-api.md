...
AWMC TEAM 使用 [Uptime Kuma](https://status.awmc.team) 监控所有服务的运行状态。我们提供了公开的 API 端点，方便开发者获取实时的服务状态数据。
...
- **完整示例**: `https://status.awmc.team/api/status-page/maimai`
...
- **完整示例**: `https://status.awmc.team/api/status-page/heartbeat/maimai`
